...
func main() {
	...
	client.AddEventHandler(func(evt interface{}) {
		...
		case *events.Connected:
			...
			//
			// This replaces our older PresencePingEnabled gate on the initial
			// SetPresence. It reaches the same goal — do not sit permanently
			// "available", which both looks like a bot and suppresses push
			// notifications on the paired phone — but dynamically rather than as a
			// static on/off. PresenceModeAlwaysOnline restores the old behaviour,
			// and PresencePingEnabled still governs the periodic ping below.
